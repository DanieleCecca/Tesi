...
def login():
    if request.method == 'POST':
        ...
        #restituisce il primo user del db con quella data e-mail
...
@auth.route('/logout')
#questo decorator fa in modo che non possiamo 
#raggiungere questa questa schermata se non siamo loggati
@login_required 
def logout():
    logout_user()
